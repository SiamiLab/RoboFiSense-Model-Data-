...
<p  align="center"> <b><code style="color : red">In case of using the model or dataset, please cite our paper, "RoboFiSense: Attention-Based Robotic Arm Activity Recognition with WiFi Sensing".</code></b> </p>
